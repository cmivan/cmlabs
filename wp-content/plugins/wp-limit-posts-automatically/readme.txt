=== Plugin Name ===
Tags: post, posts, plugin, wordpress, limit, automatically, more, tag, excerpt, description
...
1. The options to be set on posts.

== Changelog ==

[ WP YouTube 0.7 ]

* New feature - Options to strip tags added
...
add_filter('plugin_action_links_uyan/uyan_plugin.php','uyanActionLinks', 10, 2);
...
function uyan_comment_notice(){
	echo '<div class="updated" style="border:1px solid #555555; background-color:#FFFBCC;">'
...
function synchronize_post_to_tencent($title, $page, $trace_link, $pic, &$ats) {
  ...
  $url = "http://www.uyan.cc/index.php/youyan_wp_content/post_wordpress_tencent";
  $ch = curl_init();
  curl_setopt($ch, CURLOPT_URL, $url);
  curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
  curl_setopt($ch, CURLOPT_POST, 1);
...
function sychronize_post_to_sina($title, $page, $trace_link, $pic, &$ats) {
 ...
 $post_data = array(
  ...
  $url = "http://www.uyan.cc/index.php/youyan_wp_content/post_wordpress_sina";
  $ch = curl_init();
  curl_setopt($ch, CURLOPT_URL, $url);
  curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
  curl_setopt($ch, CURLOPT_POST, 1);
...
function synchronize_post_to_t163($title, $page, $trace_link, $pic, &$ats) {
 ...
 $post_data = array(
  ...
  $url = "http://www.uyan.cc/index.php/youyan_wp_content/post_wordpress_t163";
  $ch = curl_init();
  curl_setopt($ch, CURLOPT_URL, $url);
  curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
  curl_setopt($ch, CURLOPT_POST, 1);
...
function synchronize_post_to_tsohu($title, $page, $trace_link, $pic, &$ats) {
 ...
 $post_data = array(
  ...
  $url = "http://www.uyan.cc/index.php/youyan_wp_content/post_wordpress_tsohu";
  $ch = curl_init();
  curl_setopt($ch, CURLOPT_URL, $url);
  curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
  curl_setopt($ch, CURLOPT_POST, 1);

...
//by godtry
function catch_that_img($showimg='',$w=200,$h=200){
	if(!empty($showimg)){
		$catch_that_image = get_bloginfo('template_url').'/timthumb.php?src='.$showimg.'&amp;w='.$w.'&amp;h='.$h.'&amp;zc=1';
	}
return $catch_that_image;	
}
function catch_that_image_show($showimg=''){
return catch_that_img($showimg,630,150);	
}
function catch_that_left_article_img($showimg=''){
return catch_that_img($showimg,100,80);	
}
...
<?php
include('includes/widget_hot_article_img.php');?>
<?php

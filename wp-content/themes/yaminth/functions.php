...
function get_first_image() {
  ...
  if(empty($first_img)){
	  ...
	  //$first_img = get_bloginfo('template_url').'/timthumb.php?src='.$first_img.'&amp;w=675&amp;zc=1';
?>
...
?>
<?php include('includes/widget_footer.php');?>
<?php include('includes/widget_hot_article.php');?>
<?php include('includes/widget_avatar_comments.php');?>
<?php include('includes/class_iphoto.php');?>
<?php include('includes/iphoto_init.php');?>
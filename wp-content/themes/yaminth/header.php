...
<body>
	<div id="header">
		...
		<form action="<?php bloginfo('url'); ?>/" method="get">
			<input x-webkit-speech="" x-webkit-grammar="builtin:translate" type="text" value="找找看..." name="s" id="ls" class="searchfield" onfocus="if (this.value == '找找看...') {this.value = '';}" onblur="if (this.value == '') {this.value = '找找看...';}" />
		</form>
	</div>
